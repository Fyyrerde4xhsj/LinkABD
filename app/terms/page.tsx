    ...
    <div className="min-h-screen bg-neutral-50 font-sans text-neutral-900 selection:bg-orange-100">
      ...
      >
        ...
        <div className="mt-8 space-y-6 text-lg leading-8 text-neutral-600">
          ...
          <p>
            By using ShortenReal, you agree to the following terms and conditions. Please read them carefully.
          </p>
          
          <h2 className="text-2xl font-bold text-neutral-900 pt-4">1. Acceptable Use</h2>
          <p>
            You agree not to use ShortenReal for any illegal or unauthorized purpose. This includes, 
          ...
          <p>
            ShortenReal is provided &quot;as is&quot; without any warranties, express or implied. We do not 
          ...
          <p>
            ShortenReal shall not be liable for any indirect, incidental, special, or consequential 
